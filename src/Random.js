...
const Random = () =>{
    ...
    return(
        ...
        <div style={{background:'rgba(242, 242, 242,0.8)', height:'49vmax'}}>
            ...
            <h1 id='qh1'  style={{background: 'linear-gradient(to right,yellow, red,palegreen)', borderBottom:'8px white solid'}}>Random suggestions for Movies
    
            </h1>
        
            <button id='addf' onClick={handle1} style={{display:'flex', border:'3px gray solid', margin:'10px auto',background:'white', padding:'10px', borderRadius:'10px', color:'darkblue'}}>Generate Random Movies</button>
